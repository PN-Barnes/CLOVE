...
//             return;
//         } else if (dbBasketData.get({plain: true}).user_id !== req.session.userId) {
//             res.status(400).json({ message: 'Sorry you cannot edit the basket with that id!' });
//         } else {
...
//             return;
//         } else if (dbBasketData.get({plain: true}).user_id !== req.session.userId) {
//             res.status(400).json({ message: 'Sorry you cannot delete the basket with that id!' });
//         } else {
